...
// MongoDB Connection (NO hardcoded password, use env only)
...
await Product.create({
  ...
  description: 'A powerful blend of Ayurvedic herbs for sugar control.',
  price: 599,
  mrp: 999,
  images: ['https://via.placeholder.com/500'],
  benefits: ['Sugar control', 'Boost metabolism'],
  ingredients: 'Karela, Jamun, Methi',
  howToUse: '1 spoon daily'
});
